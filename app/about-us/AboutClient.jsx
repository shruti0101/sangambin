...
const AboutPage = () => {
  ...
  return (
    <div>
      ...
      {/* ===== Banner Section ===== */}
      <div
        className="relative bg-cover bg-center h-[50vh] sm:h-[60vh] md:h-[100vh] flex flex-col items-center justify-center text-center overflow-hidden px-4"
        style={{
          backgroundImage:
            "url('/ctaimg.png ')",
        }}
      >
        ...
        <div className="relative z-10 text-white max-w-3xl">
          ...
          <p className="text-white mt-4 max-w-2xl mx-auto text-sm sm:text-base md:text-lg">
      ...
      <section className="relative text-white py-12 md:py-18 px-4 sm:px-8 md:px-16">
        <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-4 text-base sm:text-lg text-blue-500 font-semibold ">
              Committed to Quality Plastic Dustbins, Hospital Dustbins & Pedal Bins Since 1988
            </p>

            <p className="mt-3 text-base sm:text-lg md:text-xl text-justify text-black leading-relaxed">
...
<section className="bg-white relative py-12 sm:py-16 px-4 sm:px-6">
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
    ...
    <div>
      ...
      <p className="text-base sm:text-lg text-black leading-relaxed mb-2">
...
<section className="max-w-7xl relative mx-auto py-12 sm:py-16 px-4 sm:px-6">
  ...
  <Image
    className="absolute hidden md:block -top-20 -right-20 animate-pulse"
    width={260}
    height={260}
    src="/eco.png"
    alt="eco"
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {[
      ...
      <div key={i} className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
        ...
        <p className="mt-2 text-black text-sm sm:text-base">{item.text}</p>
      </div>
    ))}
  </div>
</section>
...
<section className="bg-[#1a3e6a] text-white py-12 sm:py-16 px-4 sm:px-6">
  <div className="max-w-7xl mx-auto">
    ...
    <ul className="space-y-4 text-gray-200 text-base sm:text-lg xl:text-xl">
...
>
  ...
  <div className="relative max-w-7xl mx-auto text-center text-white">
    ...
    <p className="mt-5 text-base sm:text-lg md:text-xl lg:text-2xl max-w-5xl mx-auto opacity-90 leading-relaxed">
    ...
    <p className="mt-6 font-semibold text-lg sm:text-xl tracking-wide">
      Take Action Today
    </p>
