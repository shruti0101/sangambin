...
export default function HomePage() {
  ...
  const products = [
...

    {
      ...
      image: "/product/120L Large Wheeled Pedal Dustbins/1.webp",
    },

    {
      title: "Litter Bins",
      image:
        "/product/new plastic dustbin products/100L Public Litter Bins/1.webp",
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We manufacture a wide range of plastic dustbins including household bins, commercial waste bins, industrial bins, and recycling bins in various sizes, shapes, and colors.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Absolutely! Our plastic dustbins are made from high-quality, recyclable, and eco-friendly materials, ensuring durability while supporting sustainable waste management.",
    },
    {
      question: "5. What is the durability of your plastic dustbins?",
      answer:
        "Our dustbins are manufactured with premium-grade plastic, making them long-lasting, resistant to wear and tear, and easy to maintain even in heavy-duty industrial environments.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, our dustbins are designed to withstand outdoor conditions such as sun exposure, rain, and rough handling, making them ideal for both indoor and outdoor use.",
    },
    {
      question:
        "9. What makes Sangam Plastic Industries a trusted Plastic Dustbin Manufacturer?",
    ...
    },
    {
      ...
      answer:
        "While our plastic dustbins are highly durable, we provide guidance on maintenance and offer support for replacement in case of manufacturing defects or damage.",
    },
  ];
    ...
    <main className="bg-[#f7f8fa] text-slate-800">
        ...
        <div className="w-full mx-auto px-16 grid lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-3xl  md:text-4xl font-bold mb-8">
              Plastic Dustbin Manufacturer in{" "}
              <span className="text-[#0A3A49] capitalize">{city}</span> – Sangam
              Plastic Industries Private Limited
            </h2>

            <p className="mb-6 text-md text-black leading-relaxed">
              Looking for a{" "}
              <strong>reliable Plastic Dustbin Manufacturer in {city}?</strong>{" "}
              Sangam Plastic Industries Private Limited is a trusted name in
              producing high-quality, durable, and eco-friendly plastic
              dustbins. Our products are designed to meet the needs of homes,
              offices, commercial spaces, and industrial facilities, offering
              long-lasting performance and easy maintenance. With years of
              expertise in the plastic manufacturing industry, we ensure every
              dustbin is made from premium-grade materials that are both strong
              and environmentally safe. As a leading{" "}
              <Link href={"/"} className="font-bold">
                Plastic Dustbin Manufacturer,
              </Link>{" "}
              we offer a wide range of dustbins, including household bins,
              commercial waste bins, industrial dustbins, and recycling
              solutions. We also provide customized options to match specific
              requirements in size, color, and design. With a focus on quality,
              timely delivery, and customer satisfaction,{" "}
              <strong>
                Sangam Plastic Industries Private Limited is your go-to Plastic
                Dustbin Manufacturer in {city}{" "}
              </strong>{" "}
      ...
      <section className="w-full h-full">
        <div className="px-4 md:px-10 py-10 bg-white">
          ...
          >
            {products.map((item, i) => (
              <SwiperSlide key={i}>
                <div className="bg-white border  rounded-xl overflow-hidden shadow-md group">
                  {/* Image */}
                  <div className="h-[450px] overflow-hidden">
                    <img
                      src={item.image}
                      alt={item.title}
                      className="w-full h-[520px] object-contain group-hover:scale-105 transition duration-300"
                    />
                  </div>
                  ...
                  <div className="p-4 flex flex-col items-center">
                    ...
                    <a
                      href={`https://wa.me/918810422935?text=I want to enquire about ${encodeURIComponent(item.title)}`}
                      target="_blank"
                      className="mt-3 flex items-center gap-2 bg-[#00c950] text-white px-4 py-2 rounded-full text-lg font-bold"
                    >
                      WhatsApp Now <FaWhatsapp size={25} />
                    </a>
                  </div>
                </div>
              </SwiperSlide>
      ...
      <section className="py-18  bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="max-w-3xl mx-auto text-black text-lg mb-16">
            Opt for a high-quality, durable, and eco-friendly dustbin from a
            trusted
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className=" mx-auto text-gray-600 text-lg leading-relaxed">
              ...
              , we offer a diverse range of high-quality plastic products
              including Plastic Dustbins, Storage Water Tanks, Chemical Tanks,
              and Bio-Gas Plants. With our competitive range, we ensure you find
              the perfect solution for your home, office, or industrial needs.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
              Why Choose Sangam Plastic Industries as Your{" "}
      ...
      <section className="py-24 bg-[#016630]  text-white text-center">
        ...
        <p className="mt-6 text-xl text-white max-w-5xl mx-auto">
          Ready to upgrade your waste management solutions? Contact Sangam
          Plastic Industries Private Limited, the trusted Plastic Dustbin
          Manufacturer in {city}, for durable, eco-friendly, and customizable
          dustbins. Whether it’s for home, office, or industrial use, we have
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-14">
            ...
            <p className="max-w-4xl mx-auto text-gray-600 text-lg leading-relaxed">
              As a leading Plastic Dustbin Manufacturer in {city}, Sangam
              Plastic Industries Private Limited caters to a wide range of
              industries, providing durable and high-quality dustbins tailored
              to diverse requirements. Our products are designed to support
              efficient waste management, hygiene, and sustainability across
              multiple sectors.
            </p>
          </div>
          ...
          <div className="mt-10 text-center">
            <p className="max-w-4xl mx-auto text-black text-lg leading-relaxed">
              By serving these industries, Sangam Plastic Industries Private
              Limited ensures that clients across {city} and nearby regions
              receive reliable, long-lasting, and environmentally friendly waste
              management solutions from a trusted Plastic Dustbin Manufacturer
              in {city}.
            </p>
          </div>
        </div>
