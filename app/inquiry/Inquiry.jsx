...
export default function Inquiry() {
    ...
    const benefits = [
        ...
        { title: "OEM Capability", icon: Factory, color: "bg-purple-100 text-purple-600" },
        { title: "Fast Dispatch", icon: Zap, color: "bg-yellow-100 text-yellow-600" },
        { title: "Tender-ready Documentation", icon: FileText, color: "bg-indigo-100 text-indigo-600" },
        { title: "Customisation Options", icon: Settings, color: "bg-pink-100 text-pink-600" },
        { title: "Certified Products", icon: BadgeCheck, color: "bg-teal-100 text-teal-600" },
        { title: "Transparent Pricing", icon: IndianRupee, color: "bg-orange-100 text-orange-600" },
    ];
            ...
            <div className="container mx-auto px-4 lg:px-20">
                <div className="max-w-2xl text-left">
                    ...
                    <ul className="text-lg mb-6 text-black font-medium space-y-1">
                        ...
                        <li>Ideal for Hospitals, Offices & Municipal Use</li>
            ...
            <div className="container mx-auto px-6 lg:px-20 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <p className="text-lg text-gray-900 mb-6">
                        We manufacture and supply high quality plastic dustbins designed for durability, hygiene and efficient waste management. Available in multiple sizes, colours and models for hospitals, offices, municipalities and industries. Our dustbins are built with durable plastic material to ensure long lasting performance, easy maintenance and efficient waste collection, making them ideal for commercial spaces, public areas and industrial environments.
                    </p>
        ...
        <section className="py-8 bg-gradient-to-r from-[#0A3A49] to-[#024353] text-white">
            <div className="container mx-auto px-6 lg:px-20 text-center">
                ...
                <p className="max-w-2xl mx-auto text-gray-200 mb-6">
                    Looking to streamline your waste management supply chain? Need a reliable
                    manufacturer for your next tender or hospital supply contract?
                    Let’s begin a conversation — we would be happy to understand your requirements.
                </p>

                <button onClick={() => setIsOpen(true)} className="bg-white text-[#0A3A49] font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-gray-100 transition">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {benefits.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className={`w-12 h-12 flex items-center justify-center rounded-lg mb-4 ${item.color}`}>
                                    <Icon size={24} />
                                </div>
