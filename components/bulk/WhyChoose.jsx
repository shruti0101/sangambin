...
export default function WhyChoose() {
  ...
  return (
    <section className="bg-[#f4f6f3] py-8 md:py-12 px-4 md:px-8">
      ...
      "
            >
              You won the tender. Now you need a supplier who won't cost you the
              contract.
            </h1>
      ...
      <section className="bg-[#f4f6f3] pt-16 px-4 md:px-12">
            ...
            {products.map((item, i) => (
              <>
                <div
                  ...
                  className="relative group bg-white rounded-xl overflow-hidden shadow-sm border hover:shadow-md transition"
                >
                  <div className="absolute top-2 right-2 bg-[#0f5d3f] text-white text-xs px-2 py-1 rounded-md font-semibold">
                    Min. 100 Unit
                  </div>
        ...
        <div className=" mt-10 flex justify-center items-center">
          <Link
            ...
            className="bg-green-500 py-3 md:w-[35%] bg-gray-50 text-center text-white whitespace-nowrap px-12 font-semibold rounded-full shadow hover:bg-green-600  transition hover:border "
          >
