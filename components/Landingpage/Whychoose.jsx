          ...
          <div className="grid lg:grid-cols-2 gap-5 md:gap-14 items-center">
            ...
            <div className="space-y-5">
              ...
              <p className="text-[19px] text-black leading-[26px]">
                These are real challenges faced by procurement heads, tender
                bidders, and institutional buyers.
              </p>
            </div>
            {/* RIGHT IMAGE */}
  ...
  `,
      ...
      >
        <Image
          ...
          width={140}
          height={100}
          className="absolute bottom-60 left-7 animate-pulse "
          src="/dus1.png"
        ></Image>
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="lg:sticky top-38 self-start space-y-6">
            ...
            <p className="text-white max-w-xl leading-relaxed">
              At Sangam Plastic Industries Pvt. Ltd., we combine decades of
              experience, advanced manufacturing, and customer-centric solutions
              to deliver high-quality plastic dustbins, hospital dustbins, and
              plastic pedal bins that you can rely on.
            </p>
