...
const FooterInquiry = () => {
  ...
  return (
    <footer
      className="relative hidden md:block text-gray-300 pt-8 md:pt-16 pb-8 bg-cover bg-center"
      style={{
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+918810422935" className="text-white underline">
                +91-8810422935
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-5 h-5 text-[#0B6B42]" />
                <a href="tel:+919810057441" className="text-white underline">
                   +91-9810057441 
                </a>
              </div>
